<template>
  <div id="app">
    ...
    <pre id="ascii-art"><div class="art" v-for="line in asciiArray"><span v-for="bit in line">{{bit}}</span></div></pre>
  </div>
</template>
...
export default {
  ...
  methods: {
    html2Canvas() {
      var div = document.getElementById('ascii-art')
